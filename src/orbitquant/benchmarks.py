...
def benchmark_orbit_linear(
    *,
    ...
    return {
        ...
        "notes": (
            "forward_prewarmed_ms still uses OrbitQuant activation kernels plus "
            "cached dequantized weights and PyTorch linear; fused low-bit matmul "
            "is not enabled in this runtime mode."
        ),
    }
